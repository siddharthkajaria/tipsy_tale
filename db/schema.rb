...
ActiveRecord::Schema[7.0].define(version: 2025_03_10_095519) do
  ...
  create_table "game_feedbacks", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "game_id", null: false
    t.text "feedback"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "game_instructions", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["game_id"], name: "index_game_instructions_on_game_id"
  end
  ...
  add_foreign_key "game_feedbacks", "games"
  add_foreign_key "game_instructions", "games"
end
